...
bgAudio.play()
  ...
  //       document.querySelector('h4').innerText = gameCount++

  //       if(val1 === val2 && val2 === val3 && (val1+val2+val3)>=33 ){
  //       	document.querySelector('h3').innerText = "MEGA JACKPOT!"
  //       }
  //       else if(val1 === val2 && val2 === val3){
  //       	document.querySelector('h3').innerText = "JACKPOT"
  //       }
  //       else if ( val1 === val2 || val1 === val3 || val2 === val3){
  //       	document.querySelector('h3').innerText = "Mini WIN"
  //       }
  //       else if ((val1+val2+val3)>=36){
  //       	document.querySelector('h3').innerText = "ROYALS ONLY!"
  //       }
  //       else{
